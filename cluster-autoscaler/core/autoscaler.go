...
func NewAutoscaler(autoscalerBuilder AutoscalerBuilder, opts AutoscalerOptions, kubeClient kube_client.Interface,
	kubeEventRecorder kube_record.EventRecorder) (Autoscaler, errors.AutoscalerError) {
