...
func TestFindUnneededNodes(t *testing.T) {
	...
	n8.Spec.Taints = []apiv1.Taint{apiv1.Taint{Key: deletetaint.ToBeDeletedTaint, Value: strconv.FormatInt(time.Now().Unix()-301, 10)}}
	n9 := BuildTestNode("n9", 1000, 10)
	n9.Spec.Taints = []apiv1.Taint{apiv1.Taint{Key: deletetaint.ToBeDeletedTaint, Value: strconv.FormatInt(time.Now().Unix()-60, 10)}}
